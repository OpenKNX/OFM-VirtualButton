...
//   Mehrfach-Klick
#define ParamBTN_ReactionTimeMultiClick    (knx.paramByte(BTN_ParamBlockOffset + BTN_ReactionTimeMultiClick))
//   Langer Tasterdruck
#define ParamBTN_ReactionTimeLong          (knx.paramByte(BTN_ParamBlockOffset + BTN_ReactionTimeLong))
//   Extra langer Tastedruck
#define ParamBTN_ReactionTimeExtraLong     (knx.paramByte(BTN_ParamBlockOffset + BTN_ReactionTimeExtraLong))
...
// Modus
#define ParamBTN_ChannelMode               ((knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelMode) & BTN_ChannelModeMask) >> BTN_ChannelModeShift)
// Sperre
#define ParamBTN_ChannelLock               ((knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelLock) & BTN_ChannelLockMask) >> BTN_ChannelLockShift)
// Ausgabe der Klickanzahl
#define ParamBTN_ChannelMultiClickCount    ((bool)knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelMultiClickCount) & BTN_ChannelMultiClickCountMask)
// 1. Taster
#define ParamBTN_ChannelInputA             (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelInputA))
// 2. Taster
#define ParamBTN_ChannelInputB             (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelInputB))
//   Mehrfach-Klick
#define ParamBTN_ChannelReactionTimeMultiClick (knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelReactionTimeMultiClick))
//   Langer Tasterdruck
#define ParamBTN_ChannelReactionTimeLong   (knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelReactionTimeLong))
//   Extra langer Tasterdruck
#define ParamBTN_ChannelReactionTimeExtraLong (knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelReactionTimeExtraLong))
// Datentyp
#define ParamBTN_ChannelOutputShort_DPT    (knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_DPT))
// Datentyp
#define ParamBTN_ChannelOutputLong_DPT     (knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_DPT))
// Datentyp
#define ParamBTN_ChannelOutputExtraLong_DPT (knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_DPT))
// Datentyp
#define ParamBTN_ChannelOutputMulti_DPT    (knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_DPT))
// 1. Klick
#define ParamBTN_ChannelOutputMulti_Click1_Active ((bool)knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click1_Active) & BTN_ChannelOutputMulti_Click1_ActiveMask)
// 2. Klick
#define ParamBTN_ChannelOutputMulti_Click2_Active ((bool)knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click2_Active) & BTN_ChannelOutputMulti_Click2_ActiveMask)
// 3. Klick
#define ParamBTN_ChannelOutputMulti_Click3_Active ((bool)knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click3_Active) & BTN_ChannelOutputMulti_Click3_ActiveMask)
//   Wert beim Drücken
#define ParamBTN_ChannelOutputShort_Taster1_Active_Press ((bool)knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Active_Press) & BTN_ChannelOutputShort_Taster1_Active_PressMask)
//   Wert beim Loslassen
#define ParamBTN_ChannelOutputShort_Taster1_Active_Release ((bool)knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Active_Release) & BTN_ChannelOutputShort_Taster1_Active_ReleaseMask >> BTN_ChannelOutputShort_Taster1_Active_ReleaseShift)
//   Wert beim Drücken
#define ParamBTN_ChannelOutputShort_Taster2_Active_Press ((bool)knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster2_Active_Press) & BTN_ChannelOutputShort_Taster2_Active_PressMask)
//   Wert beim Loslassen
#define ParamBTN_ChannelOutputShort_Taster2_Active_Release ((bool)knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster2_Active_Release) & BTN_ChannelOutputShort_Taster2_Active_ReleaseMask)
//   Wert beim Drücken
#define ParamBTN_ChannelOutputLong_Taster1_Active_Press ((bool)knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster1_Active_Press) & BTN_ChannelOutputLong_Taster1_Active_PressMask)
//   Wert beim Loslassen
#define ParamBTN_ChannelOutputLong_Taster1_Active_Release ((bool)knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster1_Active_Release) & BTN_ChannelOutputLong_Taster1_Active_ReleaseMask)
//   Wert beim Drücken
#define ParamBTN_ChannelOutputLong_Taster2_Active_Press ((bool)knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster2_Active_Press) & BTN_ChannelOutputLong_Taster2_Active_PressMask)
//   Wert beim Loslassen
#define ParamBTN_ChannelOutputLong_Taster2_Active_Release ((bool)knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster2_Active_Release) & BTN_ChannelOutputLong_Taster2_Active_ReleaseMask)
//   Wert beim Drücken
#define ParamBTN_ChannelOutputExtraLong_Taster1_Active_Press ((bool)knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster1_Active_Press) & BTN_ChannelOutputExtraLong_Taster1_Active_PressMask)
//   Wert beim Loslassen
#define ParamBTN_ChannelOutputExtraLong_Taster1_Active_Release ((bool)knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster1_Active_Release) & BTN_ChannelOutputExtraLong_Taster1_Active_ReleaseMask)
//   Wert beim Drücken
#define ParamBTN_ChannelOutputExtraLong_Taster2_Active_Press ((bool)knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster2_Active_Press) & BTN_ChannelOutputExtraLong_Taster2_Active_PressMask)
//   Wert beim Loslassen
#define ParamBTN_ChannelOutputExtraLong_Taster2_Active_Release ((bool)knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster2_Active_Release) & BTN_ChannelOutputExtraLong_Taster2_Active_ReleaseMask)
// 
#define ParamBTN_ChannelOutputShort_Taster1_Dpt1_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Dpt1_Press))
// 
#define ParamBTN_ChannelOutputShort_Taster1_Dpt1_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Dpt1_Release))
// 
#define ParamBTN_ChannelOutputShort_Taster2_Dpt1_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster2_Dpt1_Press))
// 
#define ParamBTN_ChannelOutputShort_Taster2_Dpt1_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster2_Dpt1_Release))
// 
#define ParamBTN_ChannelOutputLong_Taster1_Dpt1_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster1_Dpt1_Press))
// 
#define ParamBTN_ChannelOutputLong_Taster1_Dpt1_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster1_Dpt1_Release))
// 
#define ParamBTN_ChannelOutputLong_Taster2_Dpt1_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster2_Dpt1_Press))
// 
#define ParamBTN_ChannelOutputLong_Taster2_Dpt1_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster2_Dpt1_Release))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster1_Dpt1_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster1_Dpt1_Press))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster1_Dpt1_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster1_Dpt1_Release))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster2_Dpt1_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster2_Dpt1_Press))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster2_Dpt1_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster2_Dpt1_Release))
// 
#define ParamBTN_ChannelOutputMulti_Click1_Dpt1 (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click1_Dpt1))
// 
#define ParamBTN_ChannelOutputMulti_Click2_Dpt1 (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click2_Dpt1))
// 
#define ParamBTN_ChannelOutputMulti_Click3_Dpt1 (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click3_Dpt1))
// 
#define ParamBTN_ChannelOutputShort_Taster1_Dpt2_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Dpt2_Press))
// 
#define ParamBTN_ChannelOutputShort_Taster1_Dpt2_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Dpt2_Release))
// 
#define ParamBTN_ChannelOutputShort_Taster2_Dpt2_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster2_Dpt2_Press))
// 
#define ParamBTN_ChannelOutputShort_Taster2_Dpt2_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster2_Dpt2_Release))
// 
#define ParamBTN_ChannelOutputLong_Taster1_Dpt2_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster1_Dpt2_Press))
// 
#define ParamBTN_ChannelOutputLong_Taster1_Dpt2_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster1_Dpt2_Release))
// 
#define ParamBTN_ChannelOutputLong_Taster2_Dpt2_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster2_Dpt2_Press))
// 
#define ParamBTN_ChannelOutputLong_Taster2_Dpt2_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster2_Dpt2_Release))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster1_Dpt2_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster1_Dpt2_Press))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster1_Dpt2_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster1_Dpt2_Release))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster2_Dpt2_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster2_Dpt2_Press))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster2_Dpt2_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster2_Dpt2_Release))
// 
#define ParamBTN_ChannelOutputMulti_Click1_Dpt2 (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click1_Dpt2))
// 
#define ParamBTN_ChannelOutputMulti_Click2_Dpt2 (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click2_Dpt2))
// 
#define ParamBTN_ChannelOutputMulti_Click3_Dpt2 (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click3_Dpt2))
// 
#define ParamBTN_ChannelOutputShort_Taster1_Dpt5_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Dpt5_Press))
// 
#define ParamBTN_ChannelOutputShort_Taster1_Dpt5_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Dpt5_Release))
// 
#define ParamBTN_ChannelOutputShort_Taster2_Dpt5_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster2_Dpt5_Press))
// 
#define ParamBTN_ChannelOutputShort_Taster2_Dpt5_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster2_Dpt5_Release))
// 
#define ParamBTN_ChannelOutputLong_Taster1_Dpt5_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster1_Dpt5_Press))
// 
#define ParamBTN_ChannelOutputLong_Taster1_Dpt5_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster1_Dpt5_Release))
// 
#define ParamBTN_ChannelOutputLong_Taster2_Dpt5_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster2_Dpt5_Press))
// 
#define ParamBTN_ChannelOutputLong_Taster2_Dpt5_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster2_Dpt5_Release))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster1_Dpt5_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster1_Dpt5_Press))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster1_Dpt5_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster1_Dpt5_Release))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster2_Dpt5_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster2_Dpt5_Press))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster2_Dpt5_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster2_Dpt5_Release))
// 
#define ParamBTN_ChannelOutputMulti_Click1_Dpt5 (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click1_Dpt5))
// 
#define ParamBTN_ChannelOutputMulti_Click2_Dpt5 (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click2_Dpt5))
// 
#define ParamBTN_ChannelOutputMulti_Click3_Dpt5 (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click3_Dpt5))
// 
#define ParamBTN_ChannelOutputShort_Taster1_Dpt5001_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Dpt5001_Press))
// 
#define ParamBTN_ChannelOutputShort_Taster1_Dpt5001_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Dpt5001_Release))
// 
#define ParamBTN_ChannelOutputShort_Taster2_Dpt5001_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster2_Dpt5001_Press))
// 
#define ParamBTN_ChannelOutputShort_Taster2_Dpt5001_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster2_Dpt5001_Release))
// 
#define ParamBTN_ChannelOutputLong_Taster1_Dpt5001_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster1_Dpt5001_Press))
// 
#define ParamBTN_ChannelOutputLong_Taster1_Dpt5001_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster1_Dpt5001_Release))
// 
#define ParamBTN_ChannelOutputLong_Taster2_Dpt5001_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster2_Dpt5001_Press))
// 
#define ParamBTN_ChannelOutputLong_Taster2_Dpt5001_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster2_Dpt5001_Release))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster1_Dpt5001_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster1_Dpt5001_Press))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster1_Dpt5001_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster1_Dpt5001_Release))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster2_Dpt5001_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster2_Dpt5001_Press))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster2_Dpt5001_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster2_Dpt5001_Release))
// 
#define ParamBTN_ChannelOutputMulti_Click1_Dpt5001 (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click1_Dpt5001))
// 
#define ParamBTN_ChannelOutputMulti_Click2_Dpt5001 (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click2_Dpt5001))
// 
#define ParamBTN_ChannelOutputMulti_Click3_Dpt5001 (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click3_Dpt5001))
// 
#define ParamBTN_ChannelOutputShort_Taster1_Dpt7_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Dpt7_Press))
// 
#define ParamBTN_ChannelOutputShort_Taster1_Dpt7_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Dpt7_Release))
// 
#define ParamBTN_ChannelOutputShort_Taster2_Dpt7_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster2_Dpt7_Press))
// 
#define ParamBTN_ChannelOutputShort_Taster2_Dpt7_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster2_Dpt7_Release))
// 
#define ParamBTN_ChannelOutputLong_Taster1_Dpt7_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster1_Dpt7_Press))
// 
#define ParamBTN_ChannelOutputLong_Taster1_Dpt7_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster1_Dpt7_Release))
// 
#define ParamBTN_ChannelOutputLong_Taster2_Dpt7_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster2_Dpt7_Press))
// 
#define ParamBTN_ChannelOutputLong_Taster2_Dpt7_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster2_Dpt7_Release))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster1_Dpt7_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster1_Dpt7_Press))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster1_Dpt7_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster1_Dpt7_Release))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster2_Dpt7_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster2_Dpt7_Press))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster2_Dpt7_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster2_Dpt7_Release))
// 
#define ParamBTN_ChannelOutputMulti_Click1_Dpt7 (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click1_Dpt7))
// 
#define ParamBTN_ChannelOutputMulti_Click2_Dpt7 (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click2_Dpt7))
// 
#define ParamBTN_ChannelOutputMulti_Click3_Dpt7 (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click3_Dpt7))
// 
#define ParamBTN_ChannelOutputShort_Taster1_Dpt18_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Dpt18_Press))
// 
#define ParamBTN_ChannelOutputShort_Taster1_Dpt18_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Dpt18_Release))
// 
#define ParamBTN_ChannelOutputShort_Taster2_Dpt18_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster2_Dpt18_Press))
// 
#define ParamBTN_ChannelOutputShort_Taster2_Dpt18_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster2_Dpt18_Release))
// 
#define ParamBTN_ChannelOutputLong_Taster1_Dpt18_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster1_Dpt18_Press))
// 
#define ParamBTN_ChannelOutputLong_Taster1_Dpt18_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster1_Dpt18_Release))
// 
#define ParamBTN_ChannelOutputLong_Taster2_Dpt18_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster2_Dpt18_Press))
// 
#define ParamBTN_ChannelOutputLong_Taster2_Dpt18_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster2_Dpt18_Release))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster1_Dpt18_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster1_Dpt18_Press))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster1_Dpt18_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster1_Dpt18_Release))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster2_Dpt18_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster2_Dpt18_Press))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster2_Dpt18_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster2_Dpt18_Release))
// 
#define ParamBTN_ChannelOutputMulti_Click1_Dpt18 (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click1_Dpt18))
// 
#define ParamBTN_ChannelOutputMulti_Click2_Dpt18 (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click2_Dpt18))
// 
#define ParamBTN_ChannelOutputMulti_Click3_Dpt18 (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputMulti_Click3_Dpt18))
// 
#define ParamBTN_ChannelOutputShort_Taster1_Dpt3007_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Dpt3007_Press))
// 
#define ParamBTN_ChannelOutputShort_Taster1_Dpt3007_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Dpt3007_Release))
// 
#define ParamBTN_ChannelOutputShort_Taster2_Dpt3007_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster2_Dpt3007_Press))
// 
#define ParamBTN_ChannelOutputShort_Taster2_Dpt3007_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster2_Dpt3007_Release))
// 
#define ParamBTN_ChannelOutputLong_Taster1_Dpt3007_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster1_Dpt3007_Press))
// 
#define ParamBTN_ChannelOutputLong_Taster1_Dpt3007_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster1_Dpt3007_Release))
// 
#define ParamBTN_ChannelOutputLong_Taster2_Dpt3007_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster2_Dpt3007_Press))
// 
#define ParamBTN_ChannelOutputLong_Taster2_Dpt3007_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster2_Dpt3007_Release))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster1_Dpt3007_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster1_Dpt3007_Press))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster1_Dpt3007_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster1_Dpt3007_Release))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster2_Dpt3007_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster2_Dpt3007_Press))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster2_Dpt3007_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster2_Dpt3007_Release))
// 
#define ParamBTN_ChannelOutputShort_Taster1_Dpt3008_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Dpt3008_Press))
// 
#define ParamBTN_ChannelOutputShort_Taster1_Dpt3008_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster1_Dpt3008_Release))
// 
#define ParamBTN_ChannelOutputShort_Taster2_Dpt3008_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster2_Dpt3008_Press))
// 
#define ParamBTN_ChannelOutputShort_Taster2_Dpt3008_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputShort_Taster2_Dpt3008_Release))
// 
#define ParamBTN_ChannelOutputLong_Taster1_Dpt3008_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster1_Dpt3008_Press))
// 
#define ParamBTN_ChannelOutputLong_Taster1_Dpt3008_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster1_Dpt3008_Release))
// 
#define ParamBTN_ChannelOutputLong_Taster2_Dpt3008_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster2_Dpt3008_Press))
// 
#define ParamBTN_ChannelOutputLong_Taster2_Dpt3008_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputLong_Taster2_Dpt3008_Release))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster1_Dpt3008_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster1_Dpt3008_Press))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster1_Dpt3008_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster1_Dpt3008_Release))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster2_Dpt3008_Press (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster2_Dpt3008_Press))
// 
#define ParamBTN_ChannelOutputExtraLong_Taster2_Dpt3008_Release (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutputExtraLong_Taster2_Dpt3008_Release))
//   Zusatzausgang (DPT1 beim Loslassen)
#define ParamBTN_ChannelOutput2Short_Taster1 ((knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutput2Short_Taster1) & BTN_ChannelOutput2Short_Taster1Mask) >> BTN_ChannelOutput2Short_Taster1Shift)
//   Zusatzausgang (DPT1 beim Loslassen)
#define ParamBTN_ChannelOutput2Short_Taster2 ((knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutput2Short_Taster2) & BTN_ChannelOutput2Short_Taster2Mask) >> BTN_ChannelOutput2Short_Taster2Shift)
//   Zusatzausgang (DPT1 beim Loslassen)
#define ParamBTN_ChannelOutput2Long_Taster1 ((knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutput2Long_Taster1) & BTN_ChannelOutput2Long_Taster1Mask) >> BTN_ChannelOutput2Long_Taster1Shift)
//   Zusatzausgang (DPT1 beim Loslassen)
#define ParamBTN_ChannelOutput2Long_Taster2 (knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutput2Long_Taster2) & BTN_ChannelOutput2Long_Taster2Mask)
//   Zusatzausgang (DPT1 beim Loslassen)
#define ParamBTN_ChannelOutput2ExtraLong_Taster1 ((knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutput2ExtraLong_Taster1) & BTN_ChannelOutput2ExtraLong_Taster1Mask) >> BTN_ChannelOutput2ExtraLong_Taster1Shift)
//   Zusatzausgang (DPT1 beim Loslassen)
#define ParamBTN_ChannelOutput2ExtraLong_Taster2 ((knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelOutput2ExtraLong_Taster2) & BTN_ChannelOutput2ExtraLong_Taster2Mask) >> BTN_ChannelOutput2ExtraLong_Taster2Shift)
// Schwellwert
#define ParamBTN_ChannelStatusThreshold    (knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelStatusThreshold))
// Zeitbasis
#define ParamBTN_ChannelStatusFallbackBase ((knx.paramByte(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelStatusFallbackBase) & BTN_ChannelStatusFallbackBaseMask) >> BTN_ChannelStatusFallbackBaseShift)
// Zeit
#define ParamBTN_ChannelStatusFallbackTime (knx.paramWord(BTN_ParamBlockOffset + _channelIndex * BTN_ParamBlockSize + BTN_ChannelStatusFallbackTime) & BTN_ChannelStatusFallbackTimeMask)
...
// Channel%C%Lock
#define KoBTN_ChannelLock               (knx.getGroupObject(BTN_KoOffset + _channelIndex * BTN_KoBlockSize) + BTN_KoChannelLock)
// Channel%C%Input1
#define KoBTN_ChannelInput1             (knx.getGroupObject(BTN_KoOffset + _channelIndex * BTN_KoBlockSize) + BTN_KoChannelInput1)
// Channel%C%Input2
#define KoBTN_ChannelInput2             (knx.getGroupObject(BTN_KoOffset + _channelIndex * BTN_KoBlockSize) + BTN_KoChannelInput2)
// Channel%C%Output1Status
#define KoBTN_ChannelOutput1Status      (knx.getGroupObject(BTN_KoOffset + _channelIndex * BTN_KoBlockSize) + BTN_KoChannelOutput1Status)
// Channel%C%Output2Status
#define KoBTN_ChannelOutput2Status      (knx.getGroupObject(BTN_KoOffset + _channelIndex * BTN_KoBlockSize) + BTN_KoChannelOutput2Status)
// Channel%C%Output3Status
#define KoBTN_ChannelOutput3Status      (knx.getGroupObject(BTN_KoOffset + _channelIndex * BTN_KoBlockSize) + BTN_KoChannelOutput3Status)
// Channel%C%Output1
#define KoBTN_ChannelOutput1            (knx.getGroupObject(BTN_KoOffset + _channelIndex * BTN_KoBlockSize) + BTN_KoChannelOutput1)
// Channel%C%Output2
#define KoBTN_ChannelOutput2            (knx.getGroupObject(BTN_KoOffset + _channelIndex * BTN_KoBlockSize) + BTN_KoChannelOutput2)
// Channel%C%Output3
#define KoBTN_ChannelOutput3            (knx.getGroupObject(BTN_KoOffset + _channelIndex * BTN_KoBlockSize) + BTN_KoChannelOutput3)
// Channel%C%Output4
#define KoBTN_ChannelOutput4            (knx.getGroupObject(BTN_KoOffset + _channelIndex * BTN_KoBlockSize) + BTN_KoChannelOutput4)
// Channel%C%Output5
#define KoBTN_ChannelOutput5            (knx.getGroupObject(BTN_KoOffset + _channelIndex * BTN_KoBlockSize) + BTN_KoChannelOutput5)
// Channel%C%Output6
#define KoBTN_ChannelOutput6            (knx.getGroupObject(BTN_KoOffset + _channelIndex * BTN_KoBlockSize) + BTN_KoChannelOutput6)

#define LOG_NumChannels               259      // uint8_t
#define LOG_StartupDelayBase          260      // 2 Bits, Bit 7-6
#define     LOG_StartupDelayBaseMask 0xC0
#define     LOG_StartupDelayBaseShift 6
#define LOG_StartupDelayTime          260      // 14 Bits, Bit 13-0
#define     LOG_StartupDelayTimeMask 0x3FFF
#define     LOG_StartupDelayTimeShift 0
#define LOG_HeartbeatDelayBase        262      // 2 Bits, Bit 7-6
#define     LOG_HeartbeatDelayBaseMask 0xC0
#define     LOG_HeartbeatDelayBaseShift 6
#define LOG_HeartbeatDelayTime        262      // 14 Bits, Bit 13-0
#define     LOG_HeartbeatDelayTimeMask 0x3FFF
#define     LOG_HeartbeatDelayTimeShift 0
#define LOG_ReadTimeDate              264      // 1 Bit, Bit 7
#define     LOG_ReadTimeDateMask 0x80
#define     LOG_ReadTimeDateShift 7
#define LOG_BuzzerInstalled           264      // 1 Bit, Bit 6
#define     LOG_BuzzerInstalledMask 0x40
#define     LOG_BuzzerInstalledShift 6
#define LOG_LedInstalled              264      // 1 Bit, Bit 5
#define     LOG_LedInstalledMask 0x20
#define     LOG_LedInstalledShift 5
#define LOG_VacationKo                264      // 1 Bit, Bit 2
#define     LOG_VacationKoMask 0x04
#define     LOG_VacationKoShift 2
#define LOG_HolidayKo                 264      // 1 Bit, Bit 1
#define     LOG_HolidayKoMask 0x02
#define     LOG_HolidayKoShift 1
#define LOG_VacationRead              264      // 1 Bit, Bit 0
#define     LOG_VacationReadMask 0x01
#define     LOG_VacationReadShift 0
#define LOG_HolidaySend               265      // 1 Bit, Bit 7
#define     LOG_HolidaySendMask 0x80
#define     LOG_HolidaySendShift 7
#define LOG_Timezone                  265      // 2 Bits, Bit 6-5
#define     LOG_TimezoneMask 0x60
#define     LOG_TimezoneShift 5
#define LOG_UseSummertime             265      // 1 Bit, Bit 4
#define     LOG_UseSummertimeMask 0x10
#define     LOG_UseSummertimeShift 4
#define LOG_Diagnose                  265      // 1 Bit, Bit 3
#define     LOG_DiagnoseMask 0x08
#define     LOG_DiagnoseShift 3
#define LOG_Watchdog                  265      // 1 Bit, Bit 2
#define     LOG_WatchdogMask 0x04
#define     LOG_WatchdogShift 2
#define LOG_Neujahr                   266      // 1 Bit, Bit 7
#define     LOG_NeujahrMask 0x80
#define     LOG_NeujahrShift 7
#define LOG_DreiKoenige               266      // 1 Bit, Bit 6
#define     LOG_DreiKoenigeMask 0x40
#define     LOG_DreiKoenigeShift 6
#define LOG_Weiberfastnacht           266      // 1 Bit, Bit 5
#define     LOG_WeiberfastnachtMask 0x20
#define     LOG_WeiberfastnachtShift 5
#define LOG_Rosenmontag               266      // 1 Bit, Bit 4
#define     LOG_RosenmontagMask 0x10
#define     LOG_RosenmontagShift 4
#define LOG_Fastnachtsdienstag        266      // 1 Bit, Bit 3
#define     LOG_FastnachtsdienstagMask 0x08
#define     LOG_FastnachtsdienstagShift 3
#define LOG_Aschermittwoch            266      // 1 Bit, Bit 2
#define     LOG_AschermittwochMask 0x04
#define     LOG_AschermittwochShift 2
#define LOG_Frauentag                 266      // 1 Bit, Bit 1
#define     LOG_FrauentagMask 0x02
#define     LOG_FrauentagShift 1
#define LOG_Gruendonnerstag           266      // 1 Bit, Bit 0
#define     LOG_GruendonnerstagMask 0x01
#define     LOG_GruendonnerstagShift 0
#define LOG_Karfreitag                267      // 1 Bit, Bit 7
#define     LOG_KarfreitagMask 0x80
#define     LOG_KarfreitagShift 7
#define LOG_Ostersonntag              267      // 1 Bit, Bit 6
#define     LOG_OstersonntagMask 0x40
#define     LOG_OstersonntagShift 6
#define LOG_Ostermontag               267      // 1 Bit, Bit 5
#define     LOG_OstermontagMask 0x20
#define     LOG_OstermontagShift 5
#define LOG_TagDerArbeit              267      // 1 Bit, Bit 4
#define     LOG_TagDerArbeitMask 0x10
#define     LOG_TagDerArbeitShift 4
#define LOG_Himmelfahrt               267      // 1 Bit, Bit 3
#define     LOG_HimmelfahrtMask 0x08
#define     LOG_HimmelfahrtShift 3
#define LOG_Pfingstsonntag            267      // 1 Bit, Bit 2
#define     LOG_PfingstsonntagMask 0x04
#define     LOG_PfingstsonntagShift 2
#define LOG_Pfingstmontag             267      // 1 Bit, Bit 1
#define     LOG_PfingstmontagMask 0x02
#define     LOG_PfingstmontagShift 1
#define LOG_Fronleichnam              267      // 1 Bit, Bit 0
#define     LOG_FronleichnamMask 0x01
#define     LOG_FronleichnamShift 0
#define LOG_Friedensfest              268      // 1 Bit, Bit 7
#define     LOG_FriedensfestMask 0x80
#define     LOG_FriedensfestShift 7
#define LOG_MariaHimmelfahrt          268      // 1 Bit, Bit 6
#define     LOG_MariaHimmelfahrtMask 0x40
#define     LOG_MariaHimmelfahrtShift 6
#define LOG_DeutscheEinheit           268      // 1 Bit, Bit 5
#define     LOG_DeutscheEinheitMask 0x20
#define     LOG_DeutscheEinheitShift 5
#define LOG_Nationalfeiertag          269      // 1 Bit, Bit 1
#define     LOG_NationalfeiertagMask 0x02
#define     LOG_NationalfeiertagShift 1
#define LOG_Reformationstag           268      // 1 Bit, Bit 4
#define     LOG_ReformationstagMask 0x10
#define     LOG_ReformationstagShift 4
#define LOG_Allerheiligen             268      // 1 Bit, Bit 3
#define     LOG_AllerheiligenMask 0x08
#define     LOG_AllerheiligenShift 3
#define LOG_BussBettag                268      // 1 Bit, Bit 2
#define     LOG_BussBettagMask 0x04
#define     LOG_BussBettagShift 2
#define LOG_MariaEmpfaengnis          269      // 1 Bit, Bit 0
#define     LOG_MariaEmpfaengnisMask 0x01
#define     LOG_MariaEmpfaengnisShift 0
#define LOG_Advent1                   268      // 1 Bit, Bit 1
#define     LOG_Advent1Mask 0x02
#define     LOG_Advent1Shift 1
#define LOG_Advent2                   268      // 1 Bit, Bit 0
#define     LOG_Advent2Mask 0x01
#define     LOG_Advent2Shift 0
#define LOG_Advent3                   269      // 1 Bit, Bit 7
#define     LOG_Advent3Mask 0x80
#define     LOG_Advent3Shift 7
#define LOG_Advent4                   269      // 1 Bit, Bit 6
#define     LOG_Advent4Mask 0x40
#define     LOG_Advent4Shift 6
#define LOG_Heiligabend               269      // 1 Bit, Bit 5
#define     LOG_HeiligabendMask 0x20
#define     LOG_HeiligabendShift 5
#define LOG_Weihnachtstag1            269      // 1 Bit, Bit 4
#define     LOG_Weihnachtstag1Mask 0x10
#define     LOG_Weihnachtstag1Shift 4
#define LOG_Weihnachtstag2            269      // 1 Bit, Bit 3
#define     LOG_Weihnachtstag2Mask 0x08
#define     LOG_Weihnachtstag2Shift 3
#define LOG_Silvester                 269      // 1 Bit, Bit 2
#define     LOG_SilvesterMask 0x04
#define     LOG_SilvesterShift 2
#define LOG_Latitude                  270      // float
#define LOG_Longitude                 274      // float
#define LOG_BuzzerSilent              278      // uint16_t
#define LOG_BuzzerNormal              280      // uint16_t
#define LOG_BuzzerLoud                282      // uint16_t
#define LOG_LedMapping                284      // 3 Bits, Bit 7-5
...
// Zeitzone
#define ParamLOG_Timezone                  ((knx.paramByte(LOG_ParamBlockOffset + LOG_Timezone) & LOG_TimezoneMask) >> LOG_TimezoneShift)
// Sommerzeit berücksichtigen
#define ParamLOG_UseSummertime             ((bool)knx.paramByte(LOG_ParamBlockOffset + LOG_UseSummertime) & LOG_UseSummertimeMask)
...
// Parameter per channel
#define LOG_ParamBlockOffset 285

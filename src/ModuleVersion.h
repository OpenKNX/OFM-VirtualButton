...
#ifndef BTN_ModuleVersion
    #pragma message "\n\n<op:verify File=\"../lib/OFM-VirtualButton/src/ModuleVersion.h\" ModuleVersion=\"" VALUE(ModuleVersion) "\" />\n\n"
    #pragma GCC error "\n\nPlease use OpenKNXproducer v2.3.4 or higher and rebuild your knxprod with correct op:verify entry\n\n"
#elif BTN_ModuleVersion != ModuleVersion
